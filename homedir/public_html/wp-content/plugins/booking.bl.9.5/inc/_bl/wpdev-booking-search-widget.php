...
class BookingSearchWidget extends WP_Widget {
	...
	$booking_search_widget_searchresults        = '';
		...
		$booking_search_widget_title  = apply_bk_filter('wpdev_check_for_active_language', $booking_search_widget_title );		//FixIn: 9.2.3.2
...
//FixIn: 8.1.3.18
function register_wpbc_search_widget() {
